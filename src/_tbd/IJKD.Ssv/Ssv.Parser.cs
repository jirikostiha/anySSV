namespace Wayout.Ssv
{
    ...
    public class SsvParser
    {
        ...
        //private IEnumerable<IList<string>> Read(IEnumerable<string> lines, bool hasHeader)
        //{
        //    lines = Filter(lines, hasHeader);
        ...
        //        yield return splitedLine;
        //    }
        //}

        //private IEnumerable<string> Filter(IEnumerable<string> lines, bool hasHeader)
        //{
        //    if (hasHeader)
        //        lines = lines.Skip(1);

        //    lines = lines.Where(l => !l.StartsWith(SsvNotation.RowCommentSymbol));
